...
m_mouse_event::m_mouse_event(QWidget *parent)
    :QWidget(parent)
{
...
void m_mouse_event::mousePressEvent(QMouseEvent *ev)
{
    qDebug() << "mouse move...";
...
void m_mouse_event::mouseReleaseEvent(QMouseEvent *ev)
{
    // 鼠标左键单击弹起
    if (ev->button() == Qt::LeftButton)
    {
...
void m_mouse_event::mouseDoubleClickEvent(QMouseEvent *)
{
    // 双击消息，会产生一次 mousePressEvent
    qDebug() << "doubleClick...";
}

void m_mouse_event::mouseMoveEvent(QMouseEvent *event)
{
    // 鼠标移动
    qDebug() << "mouse move...";
    QPoint m = event->globalPos();
...
void m_mouse_event::enterEvent(QEvent *)
{
    qDebug() << "mouse enter...";
}

void m_mouse_event::leaveEvent(QEvent *)
{
    qDebug() << "mouse leave...";
}

void m_mouse_event::wheelEvent(QWheelEvent *event)
{
     qDebug() << "wheel move...";
